...
namespace JBSolutions.Common.Collections
{
    /// <summary>
    ...
    public class DependencyList<TModel, TKey> : IList<TModel>
    {
        ...
        private void AddDependancies(DependencyListNode<TModel, TKey> node)
        {
            ...
            foreach (var dependancy in dependancies)
            {
                ...
                if (dependantNode == null)
                    Throw.Now<InvalidOperationException>(() => StringResources.MissingDependancy.With(dependancy));
        ...
        {
            Throw.Now<NotSupportedException>(() => StringResources.OperationNotSupported.With("Insert"));
        }
        ...
        {
            Throw.Now<NotSupportedException>(() => StringResources.OperationNotSupported.With("RemoveAt"));
        }
        ...
        private List<TModel> SortInternal()
        {
            ...
            Nodes.ForEach(n => Visit(n, sort, n));
        ...
        public TModel this[int index]
        {
            ...
            set { Throw.Now<NotSupportedException>(() => StringResources.OperationNotSupported.With("this.Set")); }
        }
            ...
            DependencyListNode<TModel, TKey> root)
        {
            ...
            foreach (var dependancy in node.Dependencies)
            {
                if (!Visit(dependancy, list, root) && node != root)
                    Throw.Now<InvalidOperationException>(() => StringResources.CyclicDependancy.With(dependancy.Identifier));
            }
